 ...
 * 
 * <p>This class implements a natural ordering that is <dfn>consistent with equals</dfn>
 * if and only if both types {@code S} and {@code T} are also consistent with
 * equals.  An element that is {@code null} is sorted before any non-{@code null}
 * element.
 * 
 * <p>The ordering imposed by this class is based on the first element of the
 * pair, and only if the first comparison is equal is the second element checked.
 * 
 * @param <S> the type of the first element
 * @param <T> the type of the second element
 * @author <a href="mailto:silnith@gmail.com">Kent Rosenkoetter</a>
 */
public class ComparablePair<S extends Comparable<? super S>, T extends Comparable<? super T>>
		extends Pair<S, T> implements Comparable<Pair<S, T>> {
