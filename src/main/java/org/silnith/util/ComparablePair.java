 ...
 * 
 * <p>
 * This class implements a natural ordering that is <dfn>consistent with
...
public class ComparablePair<S extends Comparable<? super S>, T extends Comparable<? super T>>
    ...
    private <U extends Comparable<? super U>> int compareToOrNull(final U a,
            final U b) {
        if (a == null) {
            if (b == null) {
                return 0;
