 ...
 * 
 * <p>Lists of this type will always have at least one element if they are
 * non-{@code null}.  An empty list cannot be represented by this implementation.
 * 
 * <p>Users of the language Lisp will recognize this paradigm as similar to
 * the {@code car}, {@code cdr}, {@code cons} concept.
 * 
...
//		}
	 ...
	 * This is equivalent to {@code get(0)}.
	 * 
	 ...
	 * list, or {@code -1} if this list does not contain the element.  More formally,
	 * returns the highest index <var>i</var> such that
	 * {@code (o==null ? get(i)==null : o.equals(get(i)))},
	 * or {@code -1} if there is no such index.
	 * 
	 * <p>This implementation iterates forward over the entire list and returns
	 * the index of the last element found.  It must iterate the entire list
	 * because this type of list cannot be iterated backwards.
	 * 
	 * @param o {@inheritDoc}
	 * @return {@inheritDoc}
